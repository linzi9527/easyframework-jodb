...
/**
 * MasterSlaveBaseDaoImpl和JODBBaseDaoImpl是一样的前者可以在新项目中使用，后者主要使用在以前的老项目中
 * @author 蓝眼泪
 * 2017-10-31上午10:15:08
 */
public class JODBBaseDaoImpl implements IBaseDao {
	
	private	DBMasterSlaveHelper dbHelper=DBMasterSlaveHelper.getInstance();
	...
	@Override
	public int[] createTables(List<String> sqlList) throws Exception {
		// TODO Auto-generated method stub
