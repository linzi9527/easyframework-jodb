...
public class MSlave3ConnectionFactory_3db2 {
	private static final Logger logger = LoggerFactory.getLogger(MSlave3ConnectionFactory_3db2.class);
...
/*	static {
	...
	private static final String             URL = "db03_slave03_url";
	private static final String        USERNAME = "db03_slave03_username";
	private static final String        PASSWORD = "db03_slave03_password";
	
	//druid
	private static final String                            INITIALSIZE="db03_slave03_initialSize";
	private static final String                                MINIDLE="db03_slave03_minIdle";
	private static final String                              maxActive="db03_slave03_maxActive";
	private static final String                                maxWait="db03_slave03_maxWait";
	private static final String          timeBetweenEvictionRunsMillis="db03_slave03_timeBetweenEvictionRunsMillis";
	private static final String             minEvictableIdleTimeMillis="db03_slave03_minEvictableIdleTimeMillis";
	private static final String  maxPoolPreparedStatementPerConnectionSize="db03_slave03_maxPoolPreparedStatementPerConnectionSize";
	private static final String                        validationQuery="db03_slave03_validationQuery";
	private static final String                                filters="db03_slave03_filters";
	private static final String                      AutoCommitOnClose="db03_slave03_autoCommitOnClose";
	private static final String              maxOpenPreparedStatements="db03_slave03_maxOpenPreparedStatements";
	private static final String                 PoolPreparedStatements="db03_slave03_poolPreparedStatements";
	private static final String                           TestOnBorrow="db03_slave03_testOnBorrow";
	private static final String                           TestOnReturn="db03_slave03_testOnReturn";
	...
	public  static  boolean    db03_db_Slave03_R =false;//默认从库为只读方式
	
	MSlave3ConnectionFactory_3db2(){}    
	...
	static {
	  ...
	  if(Is_MS_OPEN&&db03_db_Slave03_R){	
			try {
				EncryptUtils.isGOTO();
			} catch (Exception e) {
	...
	public static synchronized Connection getConnection() {
	    ...
	    private static MSlave3ConnectionFactory_3db2 instance;
	    
	    public static MSlave3ConnectionFactory_3db2 getInstance() {
	        if (instance == null&&EncryptUtils.LOCK) {
	            synchronized (MSlave3ConnectionFactory_3db2.class) {
	                if(instance == null) {
	                    instance = new MSlave3ConnectionFactory_3db2();
	                }
	                logger.info("\n"+
							"=========================================================================\n"+
							"‖                                     从03-db03数据源实例化                                                                   ‖\n"+
