...
public class MSlave5ConnectionFactory_2db2 {
	private static final Logger logger = LoggerFactory.getLogger(MSlave5ConnectionFactory_2db2.class);
...
/*	static {
	...
	*/
	...
	private static final String             URL = "db02_slave05_url";
	private static final String        USERNAME = "db02_slave05_username";
	private static final String        PASSWORD = "db02_slave05_password";
	
	//druid
	private static final String                            INITIALSIZE="db02_slave05_initialSize";
	private static final String                                MINIDLE="db02_slave05_minIdle";
	private static final String                              maxActive="db02_slave05_maxActive";
	private static final String                                maxWait="db02_slave05_maxWait";
	private static final String          timeBetweenEvictionRunsMillis="db02_slave05_timeBetweenEvictionRunsMillis";
	private static final String             minEvictableIdleTimeMillis="db02_slave05_minEvictableIdleTimeMillis";
	private static final String  maxPoolPreparedStatementPerConnectionSize="db02_slave05_maxPoolPreparedStatementPerConnectionSize";
	private static final String                        validationQuery="db02_slave05_validationQuery";
	private static final String                                filters="db02_slave05_filters";
	private static final String                      AutoCommitOnClose="db02_slave05_autoCommitOnClose";
	private static final String              maxOpenPreparedStatements="db02_slave05_maxOpenPreparedStatements";
	private static final String                 PoolPreparedStatements="db02_slave05_poolPreparedStatements";
	private static final String                           TestOnBorrow="db02_slave05_testOnBorrow";
	private static final String                           TestOnReturn="db02_slave05_testOnReturn";
	...
	public  static  boolean    db02_db_Slave05_R =false;//默认从库为只读方式
	
	MSlave5ConnectionFactory_2db2(){}    
	...
	static {
		...
		if(null!=BUNDLE){	
			...
			try {
				db02_db_Slave05_R=StringUtil.StringToBoolean(BUNDLE.getString("db02_db_Slave05_R"));
			} catch (Exception e) {
				logger.error("警告:获取db02_db_Slave05_R");
			}
	  if(Is_MS_OPEN&&db02_db_Slave05_R){	
			try {
				EncryptUtils.isGOTO();
			} catch (Exception e) {
			...
			try {
				EHCACHE   =StringUtil.StringToBoolean(BUNDLE.getString("db02_slave05_ehcache"));
			} catch (Exception e1) {
				logger.error("警告:获取db02_slave05_ehcache异常："+e1.getMessage());
			}
		...
		//driud
		 try{
				...
				dd.setTestWhileIdle(StringUtil.StringToBoolean(BUNDLE.getString("db02_slave05_testWhileIdle")));
	...
	public static synchronized Connection getConnection() {
	    ...
	    private static MSlave5ConnectionFactory_2db2 instance;
	    
	    public static MSlave5ConnectionFactory_2db2 getInstance() {
	        if (instance == null&&EncryptUtils.LOCK) {
	            synchronized (MSlave5ConnectionFactory_2db2.class) {
	                if(instance == null) {
	                    instance = new MSlave5ConnectionFactory_2db2();
	                }
	                logger.info("\n"+
							"=========================================================================\n"+
							"‖                                  从05-db02数据源实例化                                                                   ‖\n"+
