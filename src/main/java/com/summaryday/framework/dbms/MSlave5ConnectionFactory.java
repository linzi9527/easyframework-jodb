...
public class MSlave5ConnectionFactory {
	private static final Logger logger = LoggerFactory.getLogger(MSlave5ConnectionFactory.class);
...
/*	static {
	...
	private static final String             URL = "slave05_url";
	private static final String        USERNAME = "slave05_username";
	private static final String        PASSWORD = "slave05_password";
	
	//c3p0
	private static final String      MAXPOOLSIZE="slave05_MaxPoolSize";
	private static final String      MINPOOLSIZE="slave05_MinPoolSize";
	private static final String   IDLETESTPERIOD="slave05_idleConnectionTestPeriod";
	private static final String ACQUIREINCREMENT="slave05_acquireIncrement";
	private static final String  INITIALPOOLSIZE="slave05_initialPoolSize";
	private static final String    MAXSTATEMENTS="slave05_maxStatements";
	private static final String     HELPERTHEADS="slave05_numHelperThreads";
	private static final String         IDLETIME="slave05_maxIdleTime";
	private static final String    RetryAttempts="slave05_acquireRetryAttempts";
	private static final String       RetryDelay="slave05_acquireRetryDelay";
	private static final String          TIMEOUT="slave05_checkoutTimeout";
	
	
	//druid
	private static final String                            INITIALSIZE="slave05_initialSize";
	private static final String                                MINIDLE="slave05_minIdle";
	private static final String                              maxActive="slave05_maxActive";
	private static final String                                maxWait="slave05_maxWait";
	private static final String          timeBetweenEvictionRunsMillis="slave05_timeBetweenEvictionRunsMillis";
	private static final String             minEvictableIdleTimeMillis="slave05_minEvictableIdleTimeMillis";
	private static final String  maxPoolPreparedStatementPerConnectionSize="slave05_maxPoolPreparedStatementPerConnectionSize";
	private static final String                        validationQuery="slave05_validationQuery";
	private static final String                                filters="slave05_filters";
	private static final String                      AutoCommitOnClose="slave05_autoCommitOnClose";
	private static final String              maxOpenPreparedStatements="slave05_maxOpenPreparedStatements";
	private static final String                 PoolPreparedStatements="slave05_poolPreparedStatements";
	private static final String                           TestOnBorrow="slave05_testOnBorrow";
	private static final String                           TestOnReturn="slave05_testOnReturn";
	...
	public  static  boolean    db_Slave05_R =false;//默认从库为只读方式
	
	MSlave5ConnectionFactory(){}    
	...
	static {
		...
		if(null!=BUNDLE){	
			...
			try {
				...
				logger.error("警告:获取db_Slave05_R");
			}
	  if(Is_MS_OPEN&&db_Slave05_R){	
			try {
				EncryptUtils.isGOTO();
			} catch (Exception e) {
			...
			try {
				EHCACHE   =StringUtil.StringToBoolean(BUNDLE.getString("slave05_ehcache"));
			} catch (Exception e1) {
				logger.error("警告:获取slave05_ehcache异常："+e1.getMessage());
			}
		...
		//driud
		 try{
				...
				dd.setTestWhileIdle(StringUtil.StringToBoolean(BUNDLE.getString("slave05_testWhileIdle")));
	...
	public static synchronized Connection getConnection() {
	    ...
	    private static MSlave5ConnectionFactory instance;
	    
	    public static MSlave5ConnectionFactory getInstance() {
	        if (instance == null&&EncryptUtils.LOCK) {
	            synchronized (MSlave5ConnectionFactory.class) {
	                if(instance == null) {
	                    instance = new MSlave5ConnectionFactory();
	                }
	                logger.info("\n"+
							"=========================================================================\n"+
							"‖                                      	      从05数据源实例化                                                                   ‖\n"+
